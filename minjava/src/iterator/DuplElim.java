...
public class DuplElim extends Iterator
{
  ...
  private Tuple TempTuple1, TempTuple2,TempTuple3;
  ...
  /*    if((t=_am.get_next())!=null)
      {
      TempTuple1.tupleCopy(t);
      counter = 1;
      totalscore=TempTuple1.getScore();}
      else
      {
    	  done=true;
    	  return null;
      ...
      if(!first)
      {
    	  counter = 1;
          totalscore=TempTuple1.getScore();
      while((t=_am.get_next())!=null)
      {
    	  TempTuple2.tupleCopy(t);
    	  if(TupleUtils.Equal(TempTuple1, t, _in, in_len))
    	  {
    		  
    		  counter++;
    		  totalscore+=TempTuple2.getScore();
    		  TempTuple3.tupleCopy(TempTuple1);
 ...
 /*     do {
	...
	TempTuple2.tupleCopy(t);
      ...
      */
      ...
      float tempscore= totalscore/counter;
      //TempTuple2.setScore(tempscore);
      // Now copy the the TempTuple2 (new o/p tuple) into TempTuple1.
  //    TempTuple1.tupleCopy(TempTuple2);
      Jtuple.tupleCopy(TempTuple3);
      Jtuple.setScore(tempscore);
      return Jtuple ;
    }
