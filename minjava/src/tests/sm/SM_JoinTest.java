...
class Sailor {
	...
	public Sailor (int _sid, String _sname, int _rating,double _age, double _score) {
		sid    = _sid;
		sname  = _sname;
		rating = _rating;
		age    = _age;
...
class JoinsDriver implements GlobalConst {
	...
	public JoinsDriver() {
		...
		reserves.addElement(new Reserves(10, 1, "05/10/95", 0.7));
		reserves.addElement(new Reserves(21, 1, "05/11/95", 0.7));
		reserves.addElement(new Reserves(10, 2, "05/11/95", 0.7));
		reserves.addElement(new Reserves(31, 1, "05/12/95", 0.7));
		reserves.addElement(new Reserves(10, 3, "05/13/95", 0.7));
		reserves.addElement(new Reserves(69, 4, "05/12/95", 0.7));
		reserves.addElement(new Reserves(69, 5, "05/14/95", 0.7));
		reserves.addElement(new Reserves(21, 5, "05/16/95", 0.7));
		reserves.addElement(new Reserves(57, 2, "05/10/95", 0.7));
		reserves.addElement(new Reserves(35, 3, "05/15/95", 0.7));
      ...
      new ExtendedSystemDefs( "/tmp/minibase.jointestdb", "/tmp/joinlog",
		...
		for (int i=0; i<numreserves; i++) {
			try {
				...
				t.setFloFld(4, (float)((Reserves)reserves.elementAt(i)).score);
